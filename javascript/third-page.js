...
const arrowFilter1 = document.getElementById('arrow-filter1');
...
closeButton.addEventListener('click', OpenfilterWindow);
arrowFilter.addEventListener('click', OpenfilterWindow);
filter.addEventListener('click', OpenfilterWindow);
arrowFilter1.addEventListener('click', OpenfilterWindow);
filter1.addEventListener('click', OpenfilterWindow);

function OpenfilterWindow(event)  {
  arrowFilter.classList.toggle('animation-filter');
  arrowFilter1.classList.toggle('animation-filter');
  filterWindow.classList.toggle('filter-block');
  arrowSortby.classList.remove('animation-filter');
  arrowSortby1.classList.remove('animation-filter');
  sortbyWindow.classList.remove('filter-block');
}

// Sort By //

const arrowSortby = document.getElementById('arrow-sortby');
const sortbyWindow = document.getElementById('sortby-window');
const closeButton1 = document.getElementById('close-button1');
const sortby = document.getElementById('sortby');
const arrowSortby1 = document.getElementById('arrow-sortby1');
const sortby1 = document.getElementById('sortby1');

closeButton1.addEventListener('click', OpenSortbyWindow);
arrowSortby.addEventListener('click', OpenSortbyWindow);
sortby.addEventListener('click', OpenSortbyWindow);
arrowSortby1.addEventListener('click', OpenSortbyWindow);
sortby1.addEventListener('click', OpenSortbyWindow);

function OpenSortbyWindow(event)  {
  arrowSortby.classList.toggle('animation-filter');
  arrowSortby1.classList.toggle('animation-filter');
  sortbyWindow.classList.toggle('filter-block');
  arrowFilter.classList.remove('animation-filter');
  arrowFilter1.classList.remove('animation-filter');
  filterWindow.classList.remove('filter-block');
}

// Show More //

const hideClothes = document.getElementById('hide-clothes');
const showMore = document.getElementById('show-more');

showMore.addEventListener('click', ShowMore);

function ShowMore(event)  {
    hideClothes.style.display = "flex";
...
$(".like-logo").click( function() {
  $(this).toggleClass("toggle-logo");
});